...
{
    protected $fillable = ['title','link','month','year'];
    protected $dir;
    protected $url;
    public function __construct(){
        $this->dir = storage_path('app/public/projects/');
    }
    ...
    public static function getAllByMonth(){
            $useMonths = DB::table("projects")->select("month", "year")->distinct()->orderBy("year", "desc")->orderBy("month", "desc")->get();
            $resultsTable = [];
